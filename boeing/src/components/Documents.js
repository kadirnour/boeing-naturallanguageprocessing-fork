                        ...
                        {this.props.load ? 
                            <>
                                ...
                                <div className="modeBtn">
                                    ...
                                    &nbsp; */}
                                    <div>
                                        <h7>&nbsp;&nbsp;example: C:\Users\user\OneDrive\Desktop\boeing-naturallanguageprocessing\Parser\output</h7>
                                    </div> 
                                </div>
                                <div className="folderLocation">
                                    &nbsp;
                            ...
                            <>
                                ...
                                <div id="corpusName">
                                    ...
                                    <input onChange={this.handleChange} size="15" name="corpusName" placeholder="Enter Corpus Name"/>
                                    <div>
                                        <h7>&nbsp;&nbsp;*Defaults name to "corpus". Will rewrite over files with same name.</h7>
                                    </div> 
                                </div>
                            </>
                        }
